  ...
  it('renders summary and sections based on order', () => {
    const data = {
      cv: {
        ...
        workExperience: [
          { role: { id: 'Dev' }, company: { id: 'ACME' }, location: { id: 'Jakarta' }, startDate: '2020', endDate: '2022', highlights: ['A', 'B'] },
        ],
    ...
    render(<TemplateRenderer data={data} template={{ layout: 'single', sections: ['summary','workExperience','education','skills'] }} sectionsOrder={[]} />)
