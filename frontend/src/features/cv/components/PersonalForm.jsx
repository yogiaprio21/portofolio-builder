export default function PersonalForm({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label htmlFor="personal-full-name" className="text-sm text-slate-700">Nama Lengkap*</label>
        <input
      ...
      <div>
        <label htmlFor="personal-headline" className="text-sm text-slate-700">Headline</label>
        <input
      ...
      <div>
        <label htmlFor="personal-email" className="text-sm text-slate-700">Email*</label>
        <input
          id="personal-email"
          value={value.email}
      ...
      <div>
        <label htmlFor="personal-phone" className="text-sm text-slate-700">Telepon</label>
        <input
          id="personal-phone"
          value={value.phone}
      ...
      <div>
        <label htmlFor="personal-location" className="text-sm text-slate-700">Lokasi</label>
        <input
      ...
      <div>
        <label htmlFor="personal-website" className="text-sm text-slate-700">Website</label>
        <input
          id="personal-website"
          value={value.website}
      ...
      <div>
        <label htmlFor="personal-linkedin" className="text-sm text-slate-700">LinkedIn</label>
        <input
      ...
      <div>
        <label htmlFor="personal-github" className="text-sm text-slate-700">GitHub</label>
        <input
          id="personal-github"
          value={value.github}
